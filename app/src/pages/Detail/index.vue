          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd changepirce="0" v-for="spu in spuSaleAttr.spuSaleAttrValueList" :key="spu.id" :class="{active:spu.isChecked == 1}" @click="highLight(spu,spuSaleAttr.spuSaleAttrValueList)">{{spu.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
...
export default {
  ...
  methods: {
    ...
    async getAddToCart () {
      try {
        let result = await this.$store.dispatch('getAddToCart', {
