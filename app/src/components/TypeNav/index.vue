<template>
  <div class="type-nav">
    <div class="container">
      <div @mouseleave="remCateGoryIndex" @mouseenter="sortShow">
        <h2 class="all">全部商品分类</h2>
        <transition name="sort">
          <div class="sort" v-show="show">
            <div class="all-sort-list2" @click="goSearch">
              <div class="item" v-for="(c1, index) in CateGory" :key="c1.categoryId"
                @mouseenter="getCateGoryIndex(index)" :class="{ cur: CateGoryIndex == index }">
                <h3>
...
export default {
  ...
  methods: {
    // 使用普通函数，防止箭头函数的上下文问题
    getCateGoryIndex: throttle(function (index) {
